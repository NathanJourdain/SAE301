...
<a href="mon-compte/musiques/" class="py-2 px-5 mr-5 bg-violet-500 uppercase text-xs font-bold">
    <i class="fa-solid fa-music"></i>
    Mes musiques
</a>

<a href="mon-compte/factures/" class="py-2 px-5 bg-violet-500 uppercase text-xs font-bold">
    <i class="fa-solid fa-cart-shopping"></i>
    Mes Factures
</a>

<form action="mon-compte/" method="post" class="mt-5 max-w-[56rem] p-10 rounded-t-lg bg-slate-800 gap-5 gap-x-20 text-white grid grid-cols-2">
    <h2 class="text-2xl font-semibold col-span-2">Informations générales</h2>
    <?php if (isset($_SESSION['error_infos'])) : ?>
        <span class="text-red-500 font-semibold col-span-2"><?= $_SESSION['error_infos'] ?></span>
    <?php
...
<form action="mon-compte/" method="post" class="w-[56rem] mb-5 px-10 py-5 rounded-b-lg bg-slate-800 gap-5 gap-x-20 text-white grid grid-cols-2">

    <h2 class="text-2xl font-semibold col-span-2">Habitation</h2>
    <?php if (isset($_SESSION['error_location'])) : ?>
        <span class="text-red-500 font-semibold col-span-2"><?= $_SESSION['error_location'] ?></span>
    <?php
